...
$sources= array (
    'root' => $root,
    'build' => $root . '_build/',
    'source_core' => $root . 'core/components/emailresource',
    'source_assets' => $root . 'assets/components/emailresource',
    'data' => $root . '_build/data/',
    'docs' => $root . 'core/components/emailresource/docs/',
);
unset($root);
...
$category = $modx->getObject('modCategory', array('category'=>'EmailResource'));

if (! $category) {
    $category= $modx->newObject('modCategory');
    $category->set('category','EmailResource');
}
